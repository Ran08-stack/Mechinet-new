...
חוקי שפה קשיחים:
- כתוב אך ורק בעברית. אסור להשתמש במילים, ראשי תיבות או מונחים באנגלית או בכל שפה זרה אחרת.
- אם מופיע בתשובות המועמד מונח לועזי, תרגם אותו לעברית בסיכום (למשל "overwhelmed" → "מוצף", "leadership" → "מנהיגות").
- מותר להשתמש בספרות בלבד (1, 2, 3) למבנה הסיכום.
- אל תכלול שמות מותגים, פלטפורמות או טכנולוגיות באותיות לטיניות.`,
      },
      {
        role: "user",
