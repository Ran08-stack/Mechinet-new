...
export default function LoginPage() {
  ...
  return (
    <div className="grid min-h-screen font-sans lg:grid-cols-2" dir="rtl">
      {/* Brand pane */}
      <div className="relative hidden flex-col overflow-hidden bg-gradient-to-br from-[#0d2543] via-[#1a2b47] to-[#2d3f60] p-12 text-white lg:flex">
        <div
          className="pointer-events-none absolute inset-0"
          style={{
            background:
              "radial-gradient(circle at 85% 12%, rgba(254,111,66,0.22), transparent 50%), radial-gradient(circle at -5% 110%, rgba(68,221,193,0.14), transparent 55%)",
          }}
        />
        ...
        <div className="relative z-10 flex max-w-[480px] flex-1 flex-col justify-center py-8">
          <h1 className="m-0 text-[42px] font-bold leading-[1.15] tracking-[-0.02em]">
